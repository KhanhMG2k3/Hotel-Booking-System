...
<html>
  <head>
    ...
    <title>${not empty pageTitle ? pageTitle : 'Sogo Homestay - Đặt Phòng Homestay Nhanh Chóng'}</title>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/fancybox.min.css">
