            ...
            <div class="login-shell">
                ...
                <main class="login-main">
                    <section class="login-card" aria-labelledby="login-title">
                        ...
                        <p class="intro">Đăng nhập để tiếp tục hành trình nghỉ dưỡng và quản lý những đặt phòng của bạn.
                        </p>
                        ...
                        <div class="social-stack">
                            ...
                            <div id="g_id_onload"
                                 ...
                                 data-csrf-token="<%= request.getAttribute("googleLoginCsrfToken") %>"
                            ...
                            <div class="social-button google" id="googleSignInBtn"></div>
                                ...
                                <script>
                                    ...
                                    function handleGoogleCredentialResponse(response) {
                                        var csrfToken = document.getElementById("g_id_onload").dataset.csrfToken;
                                        fetch('${pageContext.request.contextPath}/google-login', {
                                            ...
                                            if (result.ok) {
                                                // Thành công → redirectPath kiểu /home, /host/dashboard, /admin/dashboard
                                                window.location.href = '${pageContext.request.contextPath}' + result.text;
                                            } else {
                                                // Thất bại → hiện message, không redirect
                                                alert(result.text || 'Đăng nhập Google thất bại.');
                                            }
                                        }).catch(function (err) {
                                            console.error(err);
                            ...
                            <!-- End Google login -->
                                    ...
                                    <button class="social-button facebook" type="button"
                                        onclick="alert('Đăng nhập Facebook đang được cập nhật.')"><i
                                            class="fa fa-facebook-square" aria-hidden="true"></i> Đăng nhập bằng
                                        Facebook</button>
                        </div>
                        ...
                        <% if (request.getAttribute("error") !=null) { %>
                            ...
                            <% } %>
                                ...
                                <p class="fine-print">Bằng việc tiếp tục, bạn đồng ý với điều khoản sử dụng và chính
                                    sách
                                    bảo mật của Sogo.</p>
                    </section>
                </main>
